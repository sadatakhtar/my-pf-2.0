...
function Main() {
  return (
    ...
    >
      <Image src={centerImg} width={80} height={80} alt="center picture" />
      <h2
        id="home"
        className="text-3xl font-medium pt-5 sm:text-5xl sm:font-medium 
     md:text-5xl md:font-medium"
      >
        Sadat Akhtar
      </h2>
      <p
        className="text-xs text-center font-light p-5 sm:text-sm 
     md:text-lg md:font-thin text-black"
      >
        Based in Birmingham - Software Developer @ NewCo - Passionate about
        coding
      </p>
